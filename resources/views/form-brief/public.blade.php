    ...
    <div class="bg-white border-b border-gray-200">
        <div class="max-w-3xl mx-auto px-4 py-6 sm:px-6">
            <div class="flex items-center gap-3">
                <img src="{{ $websiteLogoUrl }}" alt="Beyond Viral" class="h-10 w-auto flex-shrink-0 object-contain">
                <div>
                    <h1 class="text-xl font-bold text-gray-900">Formulir Brief Beyond Viral</h1>
    ...
    <div class="max-w-3xl mx-auto px-4 py-8 sm:px-6">
        ...
        <div class="bg-white rounded-xl border border-gray-200 p-6 mb-6">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <h2 class="text-lg font-semibold text-gray-900">{{ $displayBriefTitle }}</h2>
                    @if($brief->brand)
        ...
        <form action="{{ route('form-brief.submit', $brief->token) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="bg-white rounded-xl border border-gray-200 p-6">
                ...
                <p class="text-xs text-gray-400 mb-4">Tuliskan kriteria KOL yang dibutuhkan. Bisa mencakup Main KOL,
                    Opsi Macro, Nano, dll.</p>
            ...
            <div class="flex justify-end">
                <button type="button" onclick="openSubmitConfirmationModal()"
            ...
            <div class="w-full max-w-lg rounded-2xl bg-white shadow-2xl border border-gray-200 overflow-hidden">
                ...
                <div class="px-6 py-5 space-y-4">
                    <div
                        ...
                        revisi,
                        silakan hubungi sales yang menangani campaign ini.
                    </div>
