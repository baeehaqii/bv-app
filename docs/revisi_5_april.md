...
- [x] Channel yang tersedia: **Instagram, TikTok, Threads, YouTube, Facebook, Talent, X**

### Urutan Field KOL Information (KOL External)

- [x] Urutan field: **Username → Channel → Kategori**

### Tambah KOL Baru

- [x] Saat tambah KOL baru, langsung masukkan list channel-nya — proses scraping dilakukan
      satu per satu setelahnya

### Rate Card & SOW

- [x] Tambah **Rate Card per channel** di card section KOL baru / database KOL
- [x] **SOW dipindah ke bagian atas** form

---

## Modul 5: Nego & Payment (KOL)

- [x] Tambah field **"After Nego"** — real cost setelah negosiasi
- [x] Jadwal payment: **Jumat Week 1 & Week 3** setiap bulan, dibayarkan setelah KOL posting
